...
export async function generateMetadata() {
    ...
    return {
        ...
        openGraph: {
            ...
            description: article.meta_desc || article.intro || 'Prévenez les blessures en surveillant votre charge d\'entraînement.',
            ...
            <div className="max-w-4xl mx-auto px-6">
                <AnimWrapper>
                    <Breadcrumb items={[
                        ...
                        { label: article.title || 'Calculateur ACWR' }
                    ]} />

                    <Link href="/outils/" className="inline-flex items-center gap-2 text-zinc-700 hover:text-[#FF6B00] transition mt-8 mb-8 font-bold text-sm">
                        <ArrowLeft size={16} /> Retour aux outils
                    </Link>

                    <h1 className="text-4xl md:text-5xl font-bold mb-6 text-[#FF6B00]">
