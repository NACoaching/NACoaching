...
import { Award, BookOpen, Activity, HeartPulse, ChevronRight, Star } from 'lucide-react';

export const metadata = {
    title: 'Le Coach - Nolwen Albanesi | NA Coaching',
    description: 'Découvrez le parcours de Nolwen Albanesi, coach sportif certifié Master EOPS, expert en musculation, course à pied et réathlétisation. Une approche scientifique au service de votre performance.',
    openGraph: {
        title: 'Le Coach - Nolwen Albanesi | NA Coaching',
        description: 'Coach sportif expert Master EOPS, spécialiste en performance physique et réathlétisation.',
        url: 'https://na-coaching.com/coach',
        type: 'profile',
    },
    alternates: {
        canonical: 'https://na-coaching.com/coach',
    },
};
...
export default function CoachPage() {
    const personJsonLd = {
        ...
        description: 'Coach sportif certifié Master EOPS, spécialiste en musculation, course à pied, préparation physique hybride et réathlétisation.',
        url: 'https://na-coaching.com/coach',
        ...
        alumniOf: {
            ...
            name: 'Master EOPS — Entraînement et Optimisation de la Performance Sportive',
        },
        worksFor: {
            '@type': 'LocalBusiness',
            name: 'NA Coaching',
            ...
            <section className="pt-32 pb-0 bg-black text-white overflow-hidden">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-end">
                        <AnimWrapper>
                            <p className="text-[#FF6B00] font-black uppercase tracking-widest text-sm mb-4">Le Coach</p>
                            <h1 className="text-6xl md:text-8xl font-black uppercase leading-none mb-6">
                                Nolwen<br /><span className="text-[#FF6B00]">Albanesi</span>
                            </h1>
                            <p className="text-zinc-300 text-lg max-w-lg leading-relaxed mb-8">
                        ...
                        {credentials.map((cred, i) => (
                            <AnimWrapper key={i} delay={i * 0.1}>
                                <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-8 hover:border-[#FF6B00]/50 transition group">
                                    <cred.icon size={32} className="text-[#FF6B00] mb-4 group-hover:scale-110 transition" />
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <AnimWrapper>
                        <div className="text-center mb-16">
                            <h2 className="text-4xl font-black uppercase text-black mb-4">Ma <span className="text-[#FF6B00]">Philosophie</span></h2>
            ...
            <section className="py-24 bg-black text-white">
                <div className="max-w-3xl mx-auto px-6 text-center">
                    <AnimWrapper>
                        ...
                        <h2 className="text-4xl font-black uppercase mb-6">Prêt à <span className="text-[#FF6B00]">Progresser ?</span></h2>
                        <p className="text-zinc-400 mb-10 text-lg">Que tu cherches à progresser en musculation, en running ou à récupérer d'une blessure, il existe un programme fait pour toi.</p>
