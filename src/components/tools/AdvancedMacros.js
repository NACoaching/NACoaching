        ...
        <div className="max-w-xl mx-auto">
            <div className="bg-white p-8 md:p-10 rounded-3xl border border-zinc-200 shadow-2xl">
                ...
                <form onSubmit={calculate} className="space-y-8">
                    ...
                    <div className="space-y-6">
                        <div className="space-y-2">
                            <div className="flex justify-between items-end px-1">
                                <label className="text-[10px] font-bold text-zinc-600 tracking-wider">Ratio Protéines</label>
                                <span className="text-sm font-bold text-[#FF6B00]">{proteinRatio} g/kg</span>
                            </div>
                            <input
                                type="range"
                                min="1.2"
                            ...
                            />
                            <div className="flex justify-between text-[8px] font-bold text-zinc-500 italic">
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-end px-1">
                                <label className="text-[10px] font-bold text-black tracking-wider pl-1">Ratio Lipides</label>
                                <span className="text-sm font-bold text-[#FF6B00]">{fatRatio} g/kg</span>
                            </div>
                            <input
                                type="range"
                                min="0.5"
                                ...
                                className="w-full accent-[#FF6B00] h-2 bg-zinc-100 rounded-lg appearance-none cursor-pointer"
                            />
                            <div className="flex justify-between text-[8px] font-bold text-black uppercase italic">
                    ...
                    <button type="submit" className="w-full bg-black text-white font-bold py-5 rounded-2xl uppercase tracking-widest hover:bg-[#FF6B00] hover:text-black transition-all shadow-xl">
                        Calculer mes macros
                    </button>
                </form>
                    ...
                    <AnimWrapper delay={0.1}>
                        <div className="mt-12 pt-8 border-t border-zinc-100 space-y-6">
                            ...
                            <div className="bg-zinc-50 p-6 rounded-2xl space-y-3">
                                ...
                                <div className="flex gap-4 text-[9px] font-bold justify-center mt-2">
            ...
            <div className="mt-8 bg-zinc-900 text-zinc-200 p-6 rounded-2xl flex items-start gap-4">
                ...
                <p className="text-[10px] font-bold leading-relaxed tracking-tight text-zinc-400">
...
function MacroCard({ label, grams, pct, color }) {
    return (
        <div className="flex flex-col items-center p-4 rounded-2xl border border-zinc-100">
            <span className="text-[9px] font-bold text-zinc-900 mb-1">{label}</span>
            <span className="text-3xl font-bold italic text-zinc-900">{grams}<span className="text-sm not-italic opacity-60 ml-1 text-zinc-700">g</span></span>
            <div className={`mt-2 px-2 py-0.5 rounded text-[8px] font-bold text-white ${color}`}>{pct}%</div>
        </div>
    );
}
