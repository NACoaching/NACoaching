...
export default function EffectiveVolume({ hints = {} }) {
    ...
    return (
        <div className="bg-white p-8 md:p-10 rounded-3xl border border-zinc-200 shadow-2xl max-w-3xl mx-auto">
            ...
            <div className="space-y-6 mb-10">
                <p className="text-sm text-zinc-600 font-medium italic mb-6">Indiquez le nombre de <strong className="font-bold text-zinc-900 focus:outline-none">séries effectives</strong> (amenées à proximité de l'échec) par semaine pour chaque groupe musculaire.</p>
                    ...
                    return (
                        <div key={m.id} className="group">
                            <div className="flex justify-between items-end mb-3">
                                ...
                                <div className={`px-3 py-1 rounded-full text-[10px] font-bold uppercase flex items-center gap-1.5 ${status.color}`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 bg-zinc-50 rounded-xl border border-zinc-100">
                    ...
                    <ul className="space-y-2">
                        ...
                        <li className="text-[11px] text-zinc-800 font-medium flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-orange-500" /> <strong className="font-bold">20+ séries</strong> : Haut volume (avancés uniquement).</li>
                    </ul>
                </div>
                <div className="p-4 bg-zinc-50 rounded-xl border border-zinc-100 flex gap-3 items-start">
                    ...
                    <p className="text-[10px] text-zinc-900 leading-relaxed font-medium italic">
                        Ces données sont basées sur les travaux de <strong className="font-bold">Dr. Mike Israetel</strong> et <strong className="font-bold">James Krieger</strong>. Notez que la récupération dépend aussi de votre sommeil et de votre nutrition.
                    </p>
                </div>
            </div>
        </div>
