...
export default function Navbar() {
    ...
    return (
        <nav className="fixed w-full z-50 bg-black text-white py-4 px-6 border-b border-orange-600/30">
            <div className="max-w-7xl mx-auto flex justify-between items-center">
                <Link href="/" className="text-2xl font-black tracking-tighter cursor-pointer flex items-center gap-2 z-50 relative">
                    {logoUrl ? <Image src={logoUrl} alt="NA Coaching" width={40} height={40} className="object-contain" /> : <span className="text-xl font-bold">NA</span>}
