            ...
            <div className="text-zinc-800 leading-loose">
                <ReactMarkdown
                    ...
                    components={{
                        ...
                        h1: ({ node, ...props }) => <h2 className="text-3xl font-black uppercase mt-12 mb-6 text-black border-l-8 border-black pl-6 italic" {...props} />,
                        h2: ({ node, ...props }) => <h2 className="text-2xl font-black uppercase mt-12 mb-6 text-black border-b-2 border-zinc-100 pb-2" {...props} />,
                        h3: ({ node, ...props }) => <h3 className="text-xl font-black uppercase mt-8 mb-4 text-black tracking-wider" {...props} />,
